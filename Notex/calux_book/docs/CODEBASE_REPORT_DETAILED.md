...
### 11.2 Roadmap (Estimated)

**Phase 1: MVP Hardening** (1-2 months)
- [ ] Fix authorization bugs (consistent notebook-scoped auth)
...
- [ ] Org-level notebooks (team workspaces)
- [ ] Real-time collaboration (WebSocket)
- [ ] Comment/annotation system

**Phase 4: Advanced AI** (6-12 months)
- [ ] Fine-tune embeddings on user data
- [ ] Multi-modal search (images, PDFs with layout)
- [ ] Agentic workflows (search + filter + generate)
- [ ] Smart chunking (semantic chunks, not just 800 chars)
